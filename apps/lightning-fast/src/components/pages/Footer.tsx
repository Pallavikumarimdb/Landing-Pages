    ...
    return (
        <footer className=" text-center border-t border-slate-800 mt-40">
            <div className="flex flex-col items-start sm:items-center justify-center text-sm gap-28 pt-4 md:pt-10">
                ...
                <div className="flex flex-col sm:flex-row-reverse gap-28 items-start justify-between">
                    ...
                    <p className="w-[75%] lg:w-[28%] text-left">All Rights Reserved &copy; 2025</p>
                </div>
                <p className="text-3xl ">Thirtysixstudio</p>
            </div>
        </footer>
    );
}
